webpackJsonp([2, 0], [function (t, e, s) {
    ...
    e.default = {
        props: {seller: {type: Object}}, data: function () {
            ...
            "undefined" != typeof e && (document.cookie = "openid=" + e), null == i("openid") && (location.href = _.openidUrl + "?returnUrl=" + encodeURIComponent(_.sellUrl + "/#/")), this.classMap = ["decrease", "discount", "special", "invoice", "guarantee"];
            var s = window.selectedGoods;
            s = s ? JSON.parse(s) : [], this.$http.get("/sell/buyer/product/list").then(function (e) {
                e = e.body, e.code === h && (s.map(function (t) {
    ...
    o = o.build, e.default = {
        data: function () {
            return {selectedGoods: [], seller: {}, name: "师兄", phone: "18868877111", address: "慕课网大楼"}
        }, computed: {
            allPay: function () {
    ...
    t.exports = {
        render: function () {
            ...
            return s("transition", {attrs: {name: "move"}}, [s("div", {
                ...
                directives: [{
                    name: "show", rawName: "v-show", value: t.food.ratings && t.food.ratings.length,
